...
import { Lock, Mail, Shield, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
...
const LoginPage: React.FC = () => {
    ...
    if (isGoogleLoading) {
        return <LoadingScreen message="Redirecting to Google..." />;
    }
                        ...
                        <div className="bg-gray-900/50 backdrop-blur-xl rounded-3xl border border-gray-800 shadow-2xl p-8 animate-fade-in">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button
                                    ...
                                    disabled={isLoading || isGoogleLoading}
                                    className="flex items-center justify-center gap-2 px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl hover:bg-gray-800 hover:border-gray-600 transition-all group disabled:opacity-50"
                                >
                                    {isGoogleLoading ? (
