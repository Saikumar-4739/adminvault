        ...
        <RouteGuard requiredRoles={[UserRoleEnum.ADMIN, UserRoleEnum.MANAGER]}>
            <div className="h-screen flex flex-col overflow-hidden">
                ...
                <div className="flex-shrink-0 p-4 md:p-6 pb-3 md:pb-4 bg-white dark:bg-gray-900 border-b border-slate-200 dark:border-slate-700">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Employees</h1>
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6">
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white/50 dark:bg-slate-800/50 p-2 rounded-xl border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm sticky top-0 z-10 shadow-sm">
