...
@Module({
    imports: [ MailModule, PassportModule.register({ defaultStrategy: 'jwt' }), JwtModule.register({ secret: SECRET_KEY, signOptions: { expiresIn: '7d' }}), TypeOrmModule.forFeature([AuthUsersEntity, UserLoginSessionsEntity]), AuditLogsModule ],
