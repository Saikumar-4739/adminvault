...
export const configVariables: ConfigType = {
    APP_AVS_SERVICE_URL: ((typeof window !== 'undefined') ? (window as any)['_env_']?.['APP_AVS_SERVICE_URL'] : undefined) || process.env['NEXT_PUBLIC_APP_AVS_SERVICE_URL'] || process.env['APP_AVS_SERVICE_URL'] || 'https://api.inolyse.live/api',
